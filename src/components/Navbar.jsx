...
const Navbar = ({modeSwitch}) => {
  ...
  return (
    <nav className="flex lg:flex-row flex-col lg:justify-between items-center lg:px-10 py-5 container">
      <div className="logo">
        <img src="" alt="" />
      ...
      <input type="checkbox" className="border-none" onClick={()=>[setClicked(!clicked),modeSwitch(clicked)]} />
